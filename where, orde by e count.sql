-- condição um e condição dois
select *
from person.person
where lastname = 'miller' and firstname = 'anna';

-- condição um ou condição dois
select *
...
-- filtrando dados onde o firstname e o lastname é igual ao atribuido na query
select * 
from person.person
where firstname = 'Peter' and lastname = 'krebs';

-- iltrando peleos emails onde o BusinessEntituID é igual a 26
select *
